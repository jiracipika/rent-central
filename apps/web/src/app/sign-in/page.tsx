      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-1 text-sm text-gray-400">Sign in to your Rent Central account</p>
          </div>
          <div className="space-y-4">
            ...
            <button className="w-full bg-blue-600 text-white font-medium py-2.5 rounded-xl hover:bg-blue-700 transition-all">Sign In</button>
          </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          Don&apos;t have an account? <Link href="/sign-up" className="text-blue-600 hover:text-blue-700 font-medium">Sign up</Link>
        </p>
      </div>
    </div>
  );
